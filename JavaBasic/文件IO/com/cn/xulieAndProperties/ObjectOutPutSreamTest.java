...
public class ObjectOutPutSreamTest {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException{
		...
		ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("personTwo.txt"));
	...
	public static void Demo_03WriteYou() throws IOException, ClassNotFoundException{
		//优化对象的写入
